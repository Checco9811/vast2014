 ...
 * adjusted solution taken from: https://observablehq.com/@d3/hierarchical-bar-chart
 */

const d3 = require('d3');

export default function bar() {
    var margin = ({top: 30, right: 30, bottom: 0, left: 120})
        ,width = 400
        ,height = 200
        ,barStep = 20
        ,barPadding = 2 / barStep
        ,x
        ,data = []
        ,duration = 500
        ,yAxis
